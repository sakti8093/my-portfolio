    ...
    <Box backgroundColor='#262626' mt='50px' paddingTop='30px' paddingBottom='30px' borderTopRadius='30px' >
      <Box  display={{ base:'block' ,sm:'block' ,md:'flex' ,lg:'flex' }} width={{ base:'90%' ,sm:'90%' ,md:'80%' ,lg:'80%' }}  margin='auto' gap='30px'  flexWrap='wrap'>
        ...
        <Box width={{ base:'80%' ,sm:'80%' ,md:'60%' ,lg:'60%' }} margin='auto' justifyContent='flex-end' display='flex' gap='30px'  >
          <Box background='#393737' fontSize='40px' padding='20px'  width='80px' height='80px' borderRadius='50%' className='socialIconsCss' ><a style={{ color:'inherit' }} href='mailto:saktiprasad8093@gmail.com' target='blank' ><SiGmail/></a>  </Box>
          <Box  background='#393737' fontSize='40px' padding='20px'  width='80px' height='80px' borderRadius='50%' className='socialIconsCss' ><a style={{ color:'inherit' }} href='https://github.com/sakti8093' target='blank'> <AiFillGithub/></a> </Box>
          <Box  background='#393737' fontSize='40px' padding='20px'  width='80px' height='80px' borderRadius='50%' className='socialIconsCss' ><a style={{ color:'inherit' }} href='https://www.linkedin.com/in/sakti-prasad-165b31197/' target='blank'> <BsLinkedin/></a> </Box>
        </Box>
      </Box>
